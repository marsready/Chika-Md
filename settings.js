...
global.botname = 'Bunny Bot's' //ubah jadi nama bot mu, note tanda ' gausah di hapus!
global.footer = 'Mars' //ubah jadi nama mu, note tanda ' gausah di hapus!

//—————「 Set Kebutuhan Button & Kontak 」—————//
//ubah aja kalau ada yang gapunya gsh di hps anggap aja credits :), note tanda ' gausah di hapus!
global.youtube = 'https://youtube.com/c/AKUMARS'
global.ig = 'https://instagram.com/m_arifin_syam'
global.mygc = 'https://chat.whatsapp.com/CRY23lVKmXB7sCMhHmcwVw'
global.myweb = 'https://s.id/chikabot'
global.email = 'marsytofficial@gmail.com'
global.region = 'indonesia'

//—————「 Set Wm 」—————//
global.packname = '©Mars-bot' //ubah jadi nama bot mu, note tanda ' gausah di hapus!
